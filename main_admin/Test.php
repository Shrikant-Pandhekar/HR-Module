        ...
        <div class="wrapper">
            ...
            <div id="content" style="width:100%">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="" method="get" id="my-form1">
                        <div class="input-group">
                            <input type="month" class="form-control  " value="<?php echo date('Y-m'); ?>" id="date" name="date">
                            <div class="input-group-append">
                                <button type="submit" id="check" class="btn btn-primary align-right  " name="sid" value="<?php echo $_GET['sid']; ?>">
