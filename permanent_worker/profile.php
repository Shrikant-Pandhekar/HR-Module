        ...
        <div class="wrapper">
            ...
            <div id="content" style="width:100%">
                ...
                if (isset($_GET["id"]) && !empty($_GET["id"])) {
                    $n1 = $_GET["id"];
                    $Query = "SELECT * from p_worker WHERE pw_id='$n1'";
                ...
                if (isset($_POST["btn"])) {
                    ...
                    $updatequery = "UPDATE p_worker SET firstname='$fn',lastname='$ln',email='$email',phone='$phone',
                position='$position',sal='$sal', photo='$imgnewfile' WHERE pw_id='$n1'";
                    if (mysqli_query($con, $updatequery)) {
                        echo '<meta http-equiv="refresh" content="0; URL=listpw.php">';
