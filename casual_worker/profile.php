        ...
        <div class="wrapper">
            ...
            <div id="content" style="width:100%">
                ...
                if (isset($_GET["id"]) && !empty($_GET["id"])) {
                    $n1 = $_GET["id"];
                    $Query = "SELECT * from cs_worker WHERE cs_id='$n1'";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputPassword9">Shift</label>
                                    ...
                                    <input type="text" class="form-control" name="shift" readonly value=" <?php if ($shift == 'c_worker1') echo 'Shift 1';
                                                                                                            else echo 'Shift 2'; ?>">
                                </div>
                            </div>
                ...
                if (isset($_POST["btn"])) {
                    ...
                    $updatequery = "UPDATE cs_worker SET firstname='$fn',lastname='$ln',email='$email',phone='$phone',
                position='$position',sal='$sal', photo='$imgnewfile', Shift='$shift' WHERE cs_id='$n1'";
